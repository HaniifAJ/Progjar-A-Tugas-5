...
class BackendList:
    def __init__(self):
        self.servers = []
        self.servers.append(('172.16.16.101', 8001))
        self.servers.append(('172.16.16.101', 8002))
        self.servers.append(('172.16.16.101', 8003))
        self.servers.append(('172.16.16.101', 8004))
        self.current = 0
